	...
	public static void main(String args[])
	{
		...
		for(int j = 0; j < args.length; j++)
		{
			if(args[j].startsWith("-l"))
			{
				...
				{
					i = 0;
				} else if(args[j].substring(2).equals("Metal"))
				{
					i = 1;
				} else if(args[j].substring(2).equals("Windows"))
				{
					i = 2;
				} else if(args[j].substring(2).equals("Mac"))
				{
					i = 3;
				} else if(args[j].substring(2).equals("Motif"))
				{
					i = 4;
				}
			}
